...
const BookingListUser = () => {
    ...
    useEffect(() => {
        console.log("FetchingBookingById",fetchBookingById)
                        ...
                        <table className="w-full border border-gray-300">
                            ...
                            <tbody>
                                {selectedTests.map((test) => (
                                    <tr key={test._id}>
                                        <td className="border p-2">{test.testId?.name || "N/A"}</td>
                                        <td className="border p-2">{test.testId?.description || "N/A"}</td>
                                        <td className="border p-2">₹{test.testId?.finalPrice || "N/A"}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
...
//                       </button>
//                     </td>
//                     <td className="border p-2">₹{booking.totalAmount?.toFixed(0) || 0}.00</td>
//                     <td className="border p-2">{new Date(booking.bookingDate).toLocaleString()}</td>
//                     <td className="border p-2">{booking.status || "N/A"}</td>
//                   </tr>
//                 );
